...
class App:
    def __init__(self):
        ...
        self.stack.addWidget(AdminLoginScreen(self.db, self))
    ...
    def renav(self, UI, direction: int):
        #self.navUI = UI
        if direction>0: self.stack.addWidget(UI)
        self.stack.setCurrentIndex(self.widget.currentIndex()+direction)
        if direction<0: self.stack.removeWidget(UI)
